...
const PembinaAjisaka = () => {
    return (
        <section className='w-full h-auto flex flex-col items-center justify-start relative p-4 md:p-5 pb-20 md:pb-24 gap-8 md:gap-10 overflow-visible'>
            <Image  
                src={"/Background.png"}
                alt='background'
                fill
            ...
            <div className='flex flex-col items-center justify-center w-full h-auto gap-3 relative z-10'>
                ...
                <div className='relative z-30 mt-2 w-[min(92%,760px)] md:w-1/2'>
                    <Image
