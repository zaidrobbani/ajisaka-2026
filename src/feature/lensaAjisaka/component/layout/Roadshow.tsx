...
const Roadshow: React.FC<{images: string[]}> = ({images}) => {
    return (
        <section className='w-full flex flex-col items-center justify-center relative self-stretch overflow-x-clip overflow-y-visible py-16 md:py-24 lg:py-32'>
