...
const MataInformasi = () => {
  return (
    <section className="w-full h-auto flex flex-col items-center justify-center relative">
      ...
      <div className="w-full flex flex-col sm:flex-row items-center sm:items-end justify-center sm:justify-between px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-4 mt-16 sm:mt-24 md:mt-32 lg:mt-[150px] xl:mt-[200px] gap-4 sm:gap-0 sm:flex-row-reverse">
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 px-4 sm:px-8 md:px-10 mt-6 sm:mt-8 md:mt-10">
        {mataLombaData.map((item) => (
          <div
            key={item.id}
            className="flex items-center justify-center py-8 sm:py-12 md:py-16 lg:py-20 xl:py-32 px-4 sm:px-6 md:px-8 flex-col rounded-[24px] sm:rounded-[32px] md:rounded-[40px] lg:rounded-[48px] border-r border-l border-b-2 border-white bg-[rgba(255,255,255,0.10)] backdrop-blur-md"
          >
            <Image
              src={item.image}
              alt={item.alt}
