  ...
  return (
    <section className="self-stretch w-full h-screen flex flex-col items-center justify-start text-white relative">
      ...
      <div className="w-full flex items-center justify-center absolute bottom-1/6">
        <button
          className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full inline-flex items-center justify-center gap-10 border border-white/90 bg-white/10 backdrop-blur-md box-border shadow-[0_4px_4px_rgba(0,0,0,0.25)] animate-bounce [animation-duration:1.2s] cursor-pointer z-99"
          onClick={() => {
